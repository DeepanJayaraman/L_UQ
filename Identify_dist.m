...
% Column-wise 2-norm, written out rather than via vecnorm: vecnorm was
% only added in MATLAB R2017b and GNU Octave 7, and this keeps the
% package usable on the older releases DESCRIPTION allows.
DD = min(sqrt(sum((L1-Ls').^2, 1)));
