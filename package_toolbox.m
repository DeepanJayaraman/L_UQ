...
% Keep this list in step with octave/build_octave_package.py, which
% assembles the same sources into the Octave package. Omitting a file
% here ships a toolbox that fails at run time: PDF_l/CDF_l/Random_l all
% dispatch through luq_dist, and the divergences through luq_bin_fit.
names = {'lmom.m','LegendreShiftPoly.m','Identify_dist.m', ...
    ...
    'PDF_l.m','CDF_l.m','Random_l.m','KLDiv.m','JSDiv.m','KSStat.m', ...
    'luq_dist.m','luq_bin_fit.m','luq_percentile.m', ...
    'demo_example.m','demo_octave.m', ...
...
opts.Description = ['Identify a distribution family from the L-moment ', ...
    ...
    'guards and ranked fallback (fit_best), quantify identification ', ...
    'uncertainty by bootstrap, evaluate PDF/CDF/random sampling, and ', ...
    'compare fit quality via KL/JS divergence and the ', ...
    'Kolmogorov-Smirnov statistic. Requires no toolboxes. ', ...
    'Also packaged for GNU Octave (see octave/). ', ...
